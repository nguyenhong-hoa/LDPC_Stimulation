% Test nms decoder performance of differenct alpha
clear;
...
for indx_snr = list_indx
	...
	for indx_block = 1:MAX_BLOCK
		...
		for indx_coef = list_indx_coef
			if (flag(indx_coef))
				decoded_bits = mex_nr15_fec_ldpc_decoder_nms_punctured(...llr(z_c*2+1:end),
				ldpc_param_array, ldpc_param.H_col, ldpc_param.H_row,I_max,list_coef(indx_coef));
